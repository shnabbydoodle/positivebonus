export default function Advantage() { return ( <div className='mainWrapper'>
  <div className='mainContent'>
    ...
    <ul>
      ...
      <li><mark>Frame advantage is the difference in animation endlag between the attacker's attack animation and the defender's block animation, and hence who can leave the animation first and perform another action.</mark></li>
     ...
     <img src="src\assets\images\pilebunker.png" width ="100%"/>
  </div>
</div> ) }